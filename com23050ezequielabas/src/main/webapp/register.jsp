  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-graynav" height="80px">
    <div class="container" style="max-width: 100%;">
      <a class="navbar-brand ps-3 p-2 fs-3" href="index.jsp">
        <img src="Imagenes/codoacodo.png" alt="" width="130px" height="60px" class="d-inline-block align-text-center"> Registrarse
      </a>
      ...
      <div class="col-lg-8 col-xl-7">
        ...
        <form class="container" action="login.jsp">
          <article class="text-center mt-4">
            <input type="submit" class="btn-outline-light btn" value="Iniciar Sesión">
          </article>
        </form>
      </div>
    </div>
